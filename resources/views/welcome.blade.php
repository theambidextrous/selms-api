...
.wrapper{
  ...
  margin-right: auto; 
  overflow:hidden;
  box-shadow: -4px 12px 0px -6px rgba(0, 0, 0, 0.10);  
}
...
<div class="wrapper">
  <div class="TextHolder" style="width: 489px;">
    <div class="Texts">
      <div class="FourOhFour">Noo!</div>
      <div class="Maybe">Do..on't touch it<br><span>I See U</span></div>
      <div class="Bad">Let the expert fix this first.</div>
      <div class="Return">Fixing...</div>
    </div>
  </div>
  <div class="Body"> 
