...
return [
    ...
    */
    ...
    'forex_offset' => env('FOREX_OFFSET'),
    'forex_key' => env('FOREX_KEY'),
    'forex_api' => env('FOREX_API'),
    'bill_charge' => env('BILL_CHARGE'),
    ...
    */
    ...
    'fingerprint' => env('AES_FINGER'),

    'thumbprint' => env('AES_THUMB'),
    /*
    |--------------------------------------------------------------------------
